...
class BamlStreamClient:
    ...
    def RecursiveLookup(
        ...
        question: str,current_endpoint: str,api_content: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[Optional[Union[partial_types.ArchivistFollowups, partial_types.ArchivistAnswer]], Union[types.ArchivistFollowups, types.ArchivistAnswer]]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      else:
      ...
      return baml_py.BamlSyncStream[Optional[Union[partial_types.ArchivistFollowups, partial_types.ArchivistAnswer]], Union[types.ArchivistFollowups, types.ArchivistAnswer]](
        raw,
    ...
    def VoloChat(
        ...
        query: str,history: List[types.ChatHistoryItem],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[Optional[Union[partial_types.VoloResponse, partial_types.ContactArchivist]], Union[types.VoloResponse, types.ContactArchivist]]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      else:
      ...
      return baml_py.BamlSyncStream[Optional[Union[partial_types.VoloResponse, partial_types.ContactArchivist]], Union[types.VoloResponse, types.ContactArchivist]](
        raw,
